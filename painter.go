...
func drawSquare(canvas *ebiten.Image, x int, y int, color color.RGBA) {
	...
	// left
	fillPolygon(canvas, []point{{x, y}, {x + BW, y + BW}, {x + BW, y + SW - BW}, {x, y + SW}}, SQUARE_BORDER_SIDE)
	// right
	fillPolygon(canvas, []point{{x + SW, y}, {x + SW - BW, y + BW}, {x + SW - BW, y + SW - BW}, {x + SW, y + SW}}, SQUARE_BORDER_SIDE)
	// top
	fillPolygon(canvas, []point{{x, y}, {x + BW, y + BW}, {x + SW - BW, y + BW}, {x + SW, y}}, SQUARE_BORDER_TOP)
	// bottom
	fillPolygon(canvas, []point{{x, y + SW}, {x + BW, y + SW - BW}, {x + SW - BW, y + SW - BW}, {x + SW, y + SW}}, SQUARE_BORDER_BOTTOM)
}
